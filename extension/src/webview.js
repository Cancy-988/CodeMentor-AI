    ...
    <head>
      ...
      <style>
        ...
        * { box-sizing: border-box; }
        ...
        .app { height: 100%; display: flex; flex-direction: column; padding: 12px; gap: 12px; overflow: hidden; }
        .shell { flex: 1; min-height: 0; display: flex; flex-direction: column; gap: 12px; overflow: hidden; }
        ...
        .hero { padding: 16px; background: linear-gradient(135deg, rgba(255, 237, 213, 0.9), rgba(255, 255, 255, 0.98)); }
        .eyebrow { margin: 0; font-size: 11px; font-weight: 700; letter-spacing: 0.24em; text-transform: uppercase; color: var(--accent); }
        .title { margin: 6px 0 0; font-size: 18px; line-height: 1.2; color: var(--text); }
        .subtle { margin: 8px 0 0; color: var(--muted); font-size: 12px; line-height: 1.7; }
        ...
        .button { padding: 10px 14px; background: white; color: var(--text); font-size: 13px; font-weight: 700; cursor: pointer; }
        ...
        .tab-bar { display: flex; align-items: end; gap: 8px; overflow-x: auto; padding: 10px 12px 0; border-bottom: 1px solid var(--line); background: #fff7ed; }
        .tab { padding: 10px 14px; background: #fff7ed; color: #6b7280; font-size: 13px; font-weight: 700; border-bottom-left-radius: 0; border-bottom-right-radius: 0; margin-bottom: -1px; }
        ...
        .panel-body { min-height: 0; overflow: auto; padding: 14px; display: grid; gap: 12px; }
        ...
        .card-title { margin: 0; font-size: 14px; font-weight: 800; color: var(--text); letter-spacing: 0.08em; text-transform: uppercase; }
        .card-note { margin: 6px 0 0; color: var(--muted); font-size: 13px; line-height: 1.7; }
        ...
        .code-head { display: flex; align-items: center; justify-content: space-between; gap: 8px; padding: 10px 12px; border-bottom: 1px solid var(--line); background: #fff7ed; }
        .code-label { margin: 0; font-size: 11px; font-weight: 800; letter-spacing: 0.18em; text-transform: uppercase; color: #9a3412; }
        pre { margin: 0; padding: 14px; overflow: auto; font-family: Consolas, 'Liberation Mono', Menlo, monospace; font-size: 12px; line-height: 1.7; white-space: pre; color: #111827; }
        ...
        .loading { padding: 16px; display: grid; gap: 12px; }
        .loader-row { display: flex; align-items: center; gap: 12px; }
        .spinner { width: 44px; height: 44px; border-radius: 16px; border: 1px solid var(--line); background: white; display: grid; place-items: center; }
        ...
        .empty { padding: 16px; color: var(--muted); font-size: 13px; line-height: 1.7; background: #fffaf4; }
