        ...
        <div className="mx-auto max-w-4xl">
          <div className="grid grid-cols-1 md:grid-cols-2 gap-12 items-center">
            ...
            <div>
              ...
              <h3 className="text-2xl text-orange-500 font-semibold mb-4">Cancy Khendelwal</h3>
